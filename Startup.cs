...
using DigiClassroom.Models.Repositories;using Microsoft.AspNetCore.Identity.UI.Services;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options => {
                ...
                options.EnableSensitiveDataLogging(); // this will show in the log files the values used in queries (usefull when developing)
            });
